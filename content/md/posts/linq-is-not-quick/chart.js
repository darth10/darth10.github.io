(function() {
  ...
  function loadCharts () {
    $.plot($("#postchart1"),
           [
             { data: chartData1['iterative'], label: "Iterative", color: "#1e90ff" },
             { data: chartData1['linq'], label: "LINQ", color: "#ffa500" },
             { data: chartData1['linqFaster'], label: "LinqFaster", color: "#00fa9a" }
           ],
           {
             series: {
